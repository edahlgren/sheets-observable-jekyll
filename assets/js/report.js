(function () {
  ...
  var reportAPI = {
    config: function config(i, fields, data) {
  ...
  var plotAPI = {
    ...
    config: function config(vars, data) {
      var points = data.map(function (row) {
        return {
          x: +row[vars.x_index],
          y: +row[vars.y_index]
    ...
    titles: function titles(vars) {
      return [vars.x_desc + " \u2A2F", vars.y_desc];
    }
  };
  var regressionScatterplot = {
    dataFormats: ["numerical-random:xy"],
    script: "/assets/plots/regression-scatterplot.js",
    render: function render(data) {
      if (!window.regression_scatterplot) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("regression_scatterplot function isn't defined"));
      }
  ...
  var correlationMatrix = {
    dataFormats: ["numerical-random:list-all"],
    script: "/assets/plots/correlation-matrix.js",
    render: function render(data) {
      if (!window.correlation_matrix) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("correlation_matrix function isn't defined"));
      }
  ...
  var reportAPI$2 = {
    ...
    titles: function titles(i, fields) {
      return [fields.get(i.y).description, fields.get(i.x).description, fields.get(i.z).description];
    },
    makeVars: function makeVars(i, fields) {
      return ["middle=" + i.x, "middle_desc=" + fields.get(i.x).description, "top=" + i.y, "top_desc=" + fields.get(i.y).description, "bottom=" + i.z, "bottom_desc=" + fields.get(i.z).description];
    }
  };
  var plotAPI$2 = {
    parseVars: function parseVars(query_vars, header) {
    ...
    titles: function titles(vars) {
      return [vars.top_desc, vars.middle_desc, vars.bottom_desc];
    }
  };
  var triParallel = {
    dataFormats: ["numerical-random:xyz"],
    script: "/assets/plots/tri-parallel.js",
    render: function render(data) {
      if (!window.tri_parallel_coordinates) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("tri_parallel_coordinates function isn't defined"));
      }
  ...
  var reportAPI$3 = {
    ...
    titles: function titles(i, fields) {
      return ["By", fields.get(i.primary).description, " + ", fields.get(i.secondary).description];
    },
    makeVars: function makeVars(i, fields) {
      var other = i.grid.filter(function (g) {
        return g.key !== i.primary && g.key !== i.secondary;
      });
      return ["primary=" + i.primary, "primary_desc=" + fields.get(i.primary).description, "secondary=" + i.secondary, "secondary_desc=" + fields.get(i.secondary).description, "other=" + other.join(',')];
    }
  };
  var plotAPI$3 = {
    parseVars: function parseVars(query_vars, header) {
    ...
    titles: function titles(vars) {
      return ["By", vars.primary_description, " + ", vars.secondary_description];
    }
  };
  var navioGrid = {
    dataFormats: ["category:numerical-random-grid"],
    script: "/assets/plots/navio-grid.js",
    render: function render(data) {
      if (!window.navio_grid) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("navio_grid function isn't defined"));
      }
  ...
  var reportAPI$4 = {
    ...
    titles: function titles(i, fields) {
      return [fields.get(i.category).description, " \u2A2F ", fields.get(i.value).description];
    },
    makeVars: function makeVars(i, fields) {
      return ["x=" + i.category, "x_desc=" + fields.get(i.category).description, "y=" + i.value, "y_desc=" + fields.get(i.value).description];
    }
  };
  var plotAPI$4 = {
    parseVars: function parseVars(query_vars, header) {
  ...
  var horizontalDotStrip = {
    dataFormats: ["category!date:numerical-random-value"],
    script: "/assets/plots/hdot-strip.js",
    render: function render(data) {
      if (!window.horizontal_dot_strip) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("horizontal_dot_strip function isn't defined"));
      }

      return horizontal_dot_strip(data);
    },
    report: reportAPI$4,
    plot: plotAPI$4
  };
  ...
  var verticalDotStrip = {
    dataFormats: ["category-date:numerical-random-value"],
    script: "/assets/plots/vdot-strip.js",
    render: function render(data) {
      if (!window.vertical_dot_strip) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("vertical_dot_strip function isn't defined"));
      }
  ...
  var reportAPI$6 = {
    ...
    makeVars: function makeVars(i, fields) {
      return ["category=" + i.category, "value=" + i.value, "value_desc=" + fields.get(i.value).description];
    }
  };
  var plotAPI$6 = {
    parseVars: function parseVars(query_vars, header) {
  ...
  var usRegionsValue = {
    dataFormats: ["category-us-state:numerical-random-value"],
    script: "/assets/plots/us-regions-value.js",
    render: function render(data) {
      if (!window.us_regions_value) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("us_regions_value function isn't defined"));
      }
  ...
  var reportAPI$7 = {
    ...
    titles: function titles(i, fields) {
      ...
      return [fields.get(i.value).description, "(" + minDate + "-" + maxDate + ")"];
    },
    makeVars: function makeVars(i, fields) {
      var minDate = fields.get(i.date).min,
          maxDate = fields.get(i.date).max;
      return ["category=" + i.category, "date=" + i.date, "dateMin=" + minDate, "dateMax=" + maxDate, "value=" + i.value, "value_desc=" + fields.get(i.value).description];
    }
  };
  var plotAPI$7 = {
    parseVars: function parseVars(query_vars, header) {
  ...
  var usRegionsDiff = {
    dataFormats: ["category-us-state+category-date:numerical-random-value"],
    script: "/assets/plots/us-regions-diff.js",
    render: function render(data) {
      if (!window.us_regions_diff) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("us_regions_diff function isn't defined"));
      }
  ...
  var plotAPI$8 = {
    ...
    titles: function titles(vars) {
      return [vars.value_desc, "(" + vars.date_min + "-" + vars.date_max + ")"];
    }
  };
  var sparklinesList = {
    dataFormats: ["limited-category!date+category-date:numerical-random-value"],
    script: "/assets/plots/sparklines-list.js",
    render: function render(data) {
      if (!window.sparklines_difflist) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("sparklines_difflist function isn't defined"));
      }
  ...
  function sortedValues$1(values) {
    // TODO: compute mean of common dates
  ...
  var reportAPI$9 = {
    config: function config(i, fields, data) {
      ...
      for (var key in m) {
        if (m.hasOwnProperty(key)) {
          var values = sortedValues$1(m[key]);
          out.push({
            key: key,
            start: values[0],
  ...
  var lollipopDiffs = {
    dataFormats: ["category!date+category-date:numerical-random-value"],
    script: "/assets/plots/lollipop-diffs.js",
    render: function render(data) {
      if (!window.lollipop_diffmap) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("lollipop_diffmap function isn't defined"));
      }

      return lollipop_diffmap(data);
    },
    report: reportAPI$9,
    plot: plotAPI$9
  };
  ...
  var rankedPercents = {
    dataFormats: ["percent:list-all"],
    script: "/assets/plots/ranked-percents.js",
    render: function render(data) {
      if (!window.ranked_percents) {
        throw makeKnownError(ERROR_APP_RESOURCE_DOESNT_EXIST, new Error("ranked_percents function isn't defined"));
      }
  ...
  function _load_designs() {
    _load_designs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(fields, loader) {
      var _choose_designs, designs, scripts, distributions, error;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _choose_designs = choose_designs(fields), designs = _choose_designs.designs, scripts = _choose_designs.scripts;
              loader.bar.style.width = 20 + "%";
            ...
            case 11:
              return _context.abrupt("return", designs);
  ...
  function choose_designs(fields) {
    ...
    for (var _i = 0, _Object$keys = Object.keys(specs.visualizations); _i < _Object$keys.length; _i++) {
  ...
  function get_iterations(cache, fields, type1, type2) {
    // grouped
    if (type1 === "limited-category!date+category-date" && type2 === "numerical-random-value") {
    ...
    if (type1 === "category!date+category-date" && type2 === "numerical-random-value") {
      var gs = fields.categorical;
    ...
    if (type1 === "category-us-state+category-date" && type2 === "numerical-random-value") {
      var gs = fields.categorical;
    ...
    if (type1 === "category-us-state" && type2 === "numerical-random-value") {
      var gs = fields.categorical;
    ...
    if (type1 === "category-date" && type2 === "numerical-random-value") {
      var gs = fields.categorical;
    ...
    if (type1 === "category" && type2 === "numerical-random-grid") {
      var gs = fields.categorical;
    ...
    if (type1 === "numerical-random" && type2 === "xy") {
      var fs = fields.numericalRandom;
    ...
    if (type1 === "numerical-random" && type2 === "xyz") {
      var fs = fields.numericalRandom;
    ...
    if (type1 === "numerical-random" && type2 === "list-all") {
      var fs = fields.numericalRandom;
    ...
    if (type1 === "percent" && type2 === "list-all") {
      var fs = fields.numericalRandom;
  ...
  function load_scripts(_x5, _x6) {
    return _load_scripts.apply(this, arguments);
  }

  function _load_scripts() {
    _load_scripts = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(scripts, loader) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 9:
              ...
              throw makeKnownError(ERROR_CANT_GET_APP_FILE, _context3.t0);
  ...
  function render_visualizations2(_x7, _x8) {
    return _render_visualizations.apply(this, arguments);
  }

  function _render_visualizations() {
    _render_visualizations = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(config, loader) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 6:
              ...
              n = choose_n(v.iterations.length); // Iterate
            ...
            case 19:
              ...
              throw makeKnownError(ERROR_PREPARING_VISUALIZATION_INPUT, _context4.t0);

            case 22:
              _context4.prev = 22;
              _context4.next = 25;
              return v.spec.render(input);
            ...
            case 33:
              throw makeKnownError(ERROR_RENDERING_VISUALIZATION, _context4.t1);

            case 34:
              _context4.prev = 34;
              // Get a title to describe the visualization
              titles = v.spec.report.titles(iter, config.fields); // Make the plot url

              url = "/plot?" + config.identifier + "&pn=" + pn + "&v=" + v.type;
              extraQueryVars = v.spec.report.makeVars(iter, config.fields);
            ...
            case 42:
              ...
              throw makeKnownError(ERROR_FORMATTING_VISUALIZATION, _context4.t2);
      ...
      }, _callee4, null, [[15, 19], [22, 28], [34, 42]]);
    }));
    return _render_visualizations.apply(this, arguments);
  }
  ...
  function format_plot(plot_number, url, n, titles, svg) {
    ...
    wrap.href = url;
    wrap.target = "_blank";
    wrap.rel = "noopener noreferrer"; //titles.forEach(function(title) {
  ...
  var request_channel = null,
      response_channels = new Map(); // Error handling -----------------------------
  ...
  function _processStatic() {
    _processStatic = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(testId) {
      var spec, fields, data, designs, response, text, render_config;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 4:
              spec = tests[testId], fields = null, data = null, designs = null; // Try to download the fields metadata
            ...
            case 23:
              load_part1_bar.style.width = 30 + "%"; // Try to download the data
            ...
            case 42:
              load_part1_bar.style.width = 60 + "%"; // Validating
            ...
            case 75:
              ...
              showIssue(STEP_CHOOSE_VISUALIZATIONS, _context.t4);
              return _context.abrupt("return");
            ...
            case 80:
              ...
              _context.prev = 81;
              _context.next = 84;
              return render_visualizations2(render_config, {
                bar: load_part3_bar,
            ...
            case 86:
              ...
              showIssue(STEP_MAKE_VISUALIZATIONS, _context.t5);
              return _context.abrupt("return");
      ...
      }, _callee, null, [[6, 18], [25, 37], [44, 51], [56, 63], [69, 75], [81, 86]]);
    }));
    return _processStatic.apply(this, arguments);
  }
  ...
  function processGoogle(_x2, _x3) {
    return _processGoogle.apply(this, arguments);
  }

  function _processGoogle() {
    _processGoogle = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id, firstStep) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 9:
              ...
              showIssue(firstStep, _context2.t0);
            ...
            case 29:
              showIssue(STEP_GET_METADATA, _context2.t1);
              return _context2.abrupt("return");
            ...
            case 40:
              ...
              showBug(STEP_CHOOSE_SHEET, _context2.t2);
              return _context2.abrupt("return");
            ...
            case 52:
              ...
              showIssue(STEP_DOWNLOAD_FIELDS, _context2.t3);
              return _context2.abrupt("return");
            ...
            case 64:
              ...
              showIssue(STEP_DOWNLOAD_DATA, _context2.t4);
              return _context2.abrupt("return");
            ...
            case 77:
              _context2.prev = 77;
              _context2.t5 = _context2["catch"](70);
              showBug(STEP_ORGANIZE_FIELDS, _context2.t5);
              return _context2.abrupt("return");
            ...
            case 88:
              _context2.prev = 88;
              _context2.t6 = _context2["catch"](81);
              showBug(STEP_MATCH_FIELDS, _context2.t6);
              return _context2.abrupt("return");
            ...
            case 96:
              designs = _context2.sent;
              _context2.next = 103;
              break;

            case 99:
              _context2.prev = 99;
              _context2.t7 = _context2["catch"](93);
              showIssue(STEP_CHOOSE_VISUALIZATIONS, _context2.t7);
              return _context2.abrupt("return");
            ...
            case 103:
              ...
              render_config = {
                root: report,
                identifier: "id=".concat(id, "&sheet=").concat(sheet),
            ...
            case 109:
              _context2.prev = 109;
              _context2.t8 = _context2["catch"](104);
              showIssue(STEP_MAKE_VISUALIZATIONS, _context2.t8);
              return _context2.abrupt("return");
      ...
      }, _callee2, null, [[3, 9], [14, 20], [33, 40], [46, 52], [58, 64], [70, 77], [81, 88], [93, 99], [104, 109]]);
    }));
    return _processGoogle.apply(this, arguments);
  }
