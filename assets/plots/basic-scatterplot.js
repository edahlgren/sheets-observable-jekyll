(function () {
	...
	function define(runtime, observer) {
	  ...
	  main.variable(observer()).define(["md", "data"], function (md, data) {
	    return md(_templateObject(), data.length);
	  });
	  main.variable(observer("selection")).define("selection", ["d3", "width", "height", "xAxis", "yAxis", "data", "x", "y"], function (d3, width, height, xAxis, yAxis, data, x, y) {
	    ...
	    var dot = svg.append("g").attr("fill", "none").attr("stroke", "steelblue").attr("stroke-width", 1.5).selectAll("g").data(data.points).join("circle").attr("transform", function (d) {
